...
export async function POST(req: Request) {
  ...
  try {
    await transporter.sendMail({
      ...
      to: body.email,
      subject: `Your Order Confirmation – ${BUSINESS_NAME}`,
      html: `
  <div style="font-family: 'Segoe UI', sans-serif; max-width: 600px; margin: auto; padding: 24px; border: 1px solid #eee; border-radius: 8px; background: #fff;">
    ...
    />
    <h2 style="color: #f59e0b; text-align: center;">🕯️ ${BUSINESS_NAME} – Order Confirmation</h2>
...
`,
      // Optional PDF attachment (commented)
      // attachments: [
      //   {

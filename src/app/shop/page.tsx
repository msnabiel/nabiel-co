      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-6xl mx-auto">
        {filteredProducts.map((product) => (
          <Link key={product.id} href={`/product/${product.slug}`} className="group">
            <Card className="flex flex-col justify-between cursor-pointer hover:shadow-sm transition text-sm sm:text-base">
              ...
              <CardContent>
                {imageError[product.id] ? (
                  ...
                  <img
                    ...
                    alt={product.name}
                    className="rounded-md mb-2 object-cover w-full h-[120px]"
                    onError={() =>
